...
const Project: React.FC = () => {
  ...
  return (
    <>
      ...
      <Layout>
        <div className="mx-auto my-4 w-full max-w-5xl items-center rounded-xl backdrop-blur-sm">
          <main className=" mx-auto flex w-full max-w-3xl px-4 py-5 pb-12 sm:px-6 lg:px-8 ">
                  ...
                  {projectId > 0 && (
                    <>
                      <div className="sm:hidden">
                        <Button
                          size={"sm"}
                          className="px-4 py-5 text-sm font-bold"
                      ...
                      <div className="hidden sm:block">
                        <Button
                          size={"lg"}
                          className=" px-6 pb-2 pt-2 text-sm font-bold lg:text-base"
                          onClick={() => navigateToProject(previousProject)}
                        >
                          Previous Project
                        </Button>
                  ...
                  {projectId < projectOrder.length - 1 && (
                    <>
                      ...
                      <div className="hidden sm:block">
                        <Button
                          size="lg"
                          className="font-sans text-sm font-bold lg:text-base"
                          onClick={() => navigateToProject(nextProject)}
                        >
                          Next Project
                        </Button>
